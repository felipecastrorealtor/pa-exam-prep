...
export default async function AdminQuestionsPage() {
  ...
  const { data: questions } = await supabase
    ...
    .select(`
      ...
      correct, explanation_en, page_ref, enabled,
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          {rows.length} questions across {units?.length ?? 0} units. Edit the text, the
          options, the correct answer, and both explanations.
        </p>
        {missingEs > 0 && (
